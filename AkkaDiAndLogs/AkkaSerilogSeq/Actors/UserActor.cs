    ...
    public class UserActor : ReceiveActor {
        ...
        private void _(PlayMovieMessage message) {
            ...
            if (currentlyWatching != null) {
                logger.Warning("User {userId} already watching movie", message.UserId);
            }
            else {
                currentlyWatching = message.MovieName;
                logger.Info("Starting movie {movie}", currentlyWatching);
            }
        }
        ...
        private void _(StopMovieMessage message) {
            if (currentlyWatching == null) {
                ...
                logger.Info("Stopping movie {movie}", currentlyWatching);
